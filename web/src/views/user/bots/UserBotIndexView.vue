                            ...
                            <div class="modal-dialog modal-xl">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input v-model="botadd.title" type="text" class="form-control" id="add-bot-title" placeholder="title">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        <label for="add-bot-code" class="form-label">content</label>
                                        <VAceEditor
                                        ...
                                        <div class="modal fade" :id="'update-bot-modal-' + bot.id" tabindex="-1">
                                            <div class="modal-dialog modal-xl">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary" @click="update_bot(bot)">Save change</button>
